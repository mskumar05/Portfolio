...
## Overview
This portfolio now includes an AI-powered chatbot that can answer questions about Sai Kumar Mothe's professional background, experience, and skills using the Groq API with Llama 3.3 70B model.
