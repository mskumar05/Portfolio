...
const Chatbot = ({ isOpen, onClose }) => {
  const [messages, setMessages] = useState([
    {
      role: 'assistant',
      content: "Hi! I'm Sai's AI assistant. Ask me anything about my experience, skills, projects, or background in AI/ML engineering!"
    }
  ]);
    ...
    <div className="fixed bottom-4 right-4 w-96 h-[600px] bg-gradient-to-r from-bodyColor to-[#1a1a2e] border border-designColor rounded-lg shadow-2xl flex flex-col z-50">
      ...
      <div className="bg-gradient-to-r from-designColor to-[#c026d3] p-4 rounded-t-lg flex justify-between items-center">
        <div className="flex items-center gap-2">
          ...
          <div>
            <h3 className="text-white font-bold text-lg">Ask Sai</h3>
            <p className="text-gray-200 text-xs">AI-Powered Assistant</p>
          </div>
        </div>
        <button
          onClick={onClose}
