  ...
  const form = useRef();
    ...
    const sendEmail = async (e) => {
      ...
      if (!serviceId || !templateId || !publicKey) {
        setErrMsg("Contact form is not configured. Please email me directly at msk05@myyahoo.com.");
        return;
      }
      ...
      try {
        ...
        const errorMessage =
          error?.text || error?.message || "Unable to send message right now. Please email me directly at msk05@myyahoo.com.";
